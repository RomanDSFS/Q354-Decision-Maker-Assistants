    ...
    <div className="min-h-screen">
      ...
      <header className="bg-gray-800 shadow-lg">
        <div className="max-w-7xl mx-auto px-1 py-2 sm:px-6 lg:px-8 flex justify-between items-start">
          <div>
            <h5 className="text-2xl md:text-3xl font-bold text-white leading-tight">
              {t('siteTitle')}
            </h5>
              ...
              <Link key={id} href={`/decision-makers/${id}`} className="block">
                <div className="relative bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-all hover:bg-gray-750 p-4 h-full flex flex-col border border-gray-700">
                  ...
                  <div className="mt-3 pt-1">
                    <span className="inline-block px-3 py-1 text-xs md:text-sm font-bold bg-blue-700 text-blue-200 rounded-full">
